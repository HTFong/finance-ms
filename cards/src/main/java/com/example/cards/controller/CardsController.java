...
public class CardsController {
    ...
    @GetMapping("/version")
    public ResponseEntity<ResponseDto> profileVersion() {
        return ResponseEntity.status(HttpStatus.OK).body(new ResponseDto(CardsConstants.STATUS_200, profileVersion));
    }
